...
6. Зібрати reception vertical slice: ADR-003, ADR-008.
7. Підтвердити consistency reports після visits/payments/corrections: ADR-007.
8. Закрити production readiness: ADR-009, ADR-010.
9. Тримати майбутній client self-service як guardrail, а не scope v1: ADR-013.
