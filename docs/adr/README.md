...
10. Підтвердити consistency reports після visits/payments/corrections: ADR-007.
11. Закрити production readiness: ADR-009, ADR-010.
12. Тримати майбутній client self-service як guardrail, а не scope v1: ADR-013.
