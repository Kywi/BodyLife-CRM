...
Джерело: accepted ADR package у `docs/adr/`, ADR-001..ADR-014, initial package accepted 2026-07-07 and ADR-014 accepted 2026-07-14.
...
- ADR traceability gate: each module boundary, command rule, report rule, audit rule and out-of-scope rejection must cite ADR-001..ADR-014 or stay out of the baseline.
