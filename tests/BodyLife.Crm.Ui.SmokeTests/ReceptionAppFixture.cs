...
public sealed record AuditExplanationSmokeScenario(
    ...
    NonWorkingDayAdditionAuditExplanationSmokeScenario NonWorkingDayAddition,
    ...
    FreezeAdditionAuditExplanationSmokeScenario FreezeAddition,
    ...
    MembershipOpeningStateCreationAuditExplanationSmokeScenario
        MembershipOpeningStateCreation);

public sealed record NonWorkingDayAdditionAuditExplanationSmokeScenario(
    Guid AuditEntryId,
    Guid PeriodId,
    DateRange Range,
    string ReasonCode,
    ...
    Guid FirstClientId,
    int AffectedCount,
    string PreviewScopeLabel,
    DateTimeOffset PreviewIssuedAt,
...
public sealed record PaymentCreationAuditExplanationSmokeScenario(
    Guid AuditEntryId,
    Guid PaymentId,
    Guid ClientId,
    Guid MembershipId,
...
public sealed record MembershipOpeningStateCreationAuditExplanationSmokeScenario(
    Guid AuditEntryId,
    Guid OpeningStateId,
    Guid MembershipId,
    Guid ClientId,
...
public sealed record FreezeAdditionAuditExplanationSmokeScenario(
    Guid AuditEntryId,
    Guid FreezeId,
    Guid ClientId,
    Guid MembershipId,
