...
internal static class MembershipDependencyInspector
{
    ...
    [
        ...
        typeof(GetEndingSoonMembershipStateRowsQuery),
        typeof(GetEndingSoonMembershipStateRowsResult),
        typeof(GetEndingSoonMembershipStateRowsStatus),
        typeof(EndingSoonMembershipStateRowsPage),
        typeof(EndingSoonMembershipStateSourceRow),
        typeof(GetLowRemainingMembershipStateRowsQuery),
        typeof(GetLowRemainingMembershipStateRowsResult),
        typeof(GetLowRemainingMembershipStateRowsStatus),
        typeof(LowRemainingMembershipStateRowsPage),
        typeof(LowRemainingMembershipStateSourceRow),
        typeof(GetNegativeMembershipStateRowsQuery),
        typeof(GetNegativeMembershipStateRowsResult),
        typeof(GetNegativeMembershipStateRowsStatus),
        typeof(NegativeMembershipStateRowsPage),
        typeof(NegativeMembershipStateSourceRow),
        typeof(GetReceptionAttentionCountsQuery),
        typeof(GetReceptionAttentionCountsResult),
        typeof(GetReceptionAttentionCountsStatus),
        typeof(GetClientMembershipReportStatesQuery),
        typeof(GetClientMembershipReportStatesResult),
        typeof(GetClientMembershipReportStatesStatus),
        typeof(ClientMembershipReportState),
        typeof(ClientMembershipReportStates),
        ...
        typeof(GetClientMembershipExtensionExplanationsQuery),
        typeof(GetClientMembershipExtensionExplanationsResult),
        typeof(GetClientMembershipExtensionExplanationsStatus),
        typeof(ClientMembershipExtensionExplanations),
        typeof(MembershipExtensionExplanation),
        typeof(MembershipExtensionSourceKind),
        typeof(MembershipExtensionSourceStatus),
        typeof(GetClientMembershipHistorySourceRowsQuery),
        typeof(GetClientMembershipHistorySourceRowsResult),
        typeof(GetClientMembershipHistorySourceRowsStatus),
        typeof(ClientMembershipHistorySourceRowsPage),
        typeof(ClientMembershipHistorySourceRow),
        typeof(ClientMembershipHistorySourceKind),
        typeof(IssuedMembershipHistorySource),
        typeof(MembershipOpeningStateHistorySource),
        typeof(MembershipOpeningStateSourceStatus),
        ...
        typeof(MembershipIssuePredecessor),
        typeof(MembershipIssuePreviewToken),
        typeof(IMembershipIssuePreviewTokenService),
        typeof(MembershipIssueNegativeContext),
        typeof(MembershipNegativeHandlingDecision),
        typeof(MembershipNegativeHandlingOption),
        typeof(MembershipNegativeVisitCoverageCandidate),
        typeof(GetClientNegativeVisitCoverageQuery),
        typeof(GetClientNegativeVisitCoverageResult),
        typeof(GetClientNegativeVisitCoverageStatus),
        typeof(ClientNegativeVisitCoverageReadModel),
        typeof(NegativeVisitCoverageCandidateReadModel),
        typeof(OneOffMembershipTypeReadModel),
        typeof(NegativeVisitCoverageClosureReadModel),
        typeof(IssuedMembershipCoverageSnapshotReadModel),
        typeof(NegativeVisitCoverageLineReadModel),
        typeof(NegativeVisitCoverageItemReadModel),
        typeof(NegativeVisitCoveragePaymentReadModel),
        typeof(NegativeVisitCoverageStaleSelectors),
        typeof(OneOffNegativeClosureSelectorReadModel),
        typeof(OneOffNegativeClosurePreviewLine),
        typeof(OneOffNegativeClosurePreview),
        typeof(NegativeVisitCoveragePaymentContextReadModel),
        typeof(NegativeVisitCoverageCoveringMembershipPreview),
        typeof(NegativeVisitCoverageCorrectionPreview),
        typeof(GetClientNegativeVisitCoverageHistorySourceRowsQuery),
        typeof(GetClientNegativeVisitCoverageHistorySourceRowsResult),
        typeof(GetClientNegativeVisitCoverageHistorySourceRowsStatus),
        typeof(ClientNegativeVisitCoverageHistorySourceRowsPage),
        typeof(ClientNegativeVisitCoverageHistorySourceRow),
        typeof(ClientNegativeVisitCoverageHistorySourceKind),
        typeof(NegativeVisitCoverageClosureHistorySnapshot),
        typeof(NegativeVisitCoverageClosureHistoryStatus),
        typeof(NegativeVisitCoverageClosureMethod),
        typeof(NegativeVisitCoverageLineHistorySnapshot),
        typeof(NegativeVisitCoverageItemHistorySnapshot),
        typeof(NegativeVisitCoveragePaymentHistorySnapshot),
        typeof(NegativeVisitCoverageCoveringMembershipHistorySnapshot),
        typeof(NegativeVisitCoverageCorrectionHistorySnapshot),
        typeof(NegativeVisitCoverageCorrectionHistoryMode),
        typeof(PreviewCloseNegativeVisitsOneOffQuery),
        typeof(PreviewCloseNegativeVisitsOneOffResult),
        typeof(PreviewCloseNegativeVisitsOneOffStatus),
        typeof(PreviewCorrectNegativeVisitCoverageQuery),
        typeof(PreviewCorrectNegativeVisitCoverageResult),
        typeof(PreviewCorrectNegativeVisitCoverageStatus),
        typeof(CloseNegativeVisitsOneOffCommand),
        typeof(CorrectNegativeVisitCoverageCommand),
        typeof(NegativeVisitClosureLineSelection),
        typeof(NegativeVisitCoverageCorrectionMode),
        typeof(PreviewIssuedMembershipSaleCorrectionQuery),
        typeof(PreviewIssuedMembershipSaleCorrectionResult),
        typeof(PreviewIssuedMembershipSaleCorrectionStatus),
        typeof(IssuedMembershipSaleCorrectionPreview),
        typeof(IssuedMembershipSaleDetails),
        typeof(IssuedMembershipSaleDependency),
        typeof(IssuedMembershipSaleReplacementTerms),
        typeof(ReplaceIssuedMembershipCommand),
        typeof(CancelIssuedMembershipSaleCommand),
        ...
        typeof(MembershipFreezeEligibility),
        typeof(MembershipFreezeEligibilityStatus),
        typeof(MembershipFreezeEligibilityErrorCodes),
        typeof(IMembershipVisitFreezeSourceProvider),
        typeof(IMembershipVisitFreezeSourceSnapshotProvider),
        typeof(IMembershipExtensionSourceProvider),
        typeof(MembershipExtensionSourceRange),
        typeof(IMembershipNonWorkingDayApplicationSourceProvider),
        typeof(IMembershipNonWorkingDayAffectedScopePreparer),
        typeof(MembershipNonWorkingDayAffectedScope),
        typeof(MembershipNonWorkingDayAffectedScopeItem),
        typeof(IMembershipNonWorkingDayImpactPreparer),
        typeof(MembershipNonWorkingDayImpactPreparation),
        typeof(MembershipNonWorkingDayImpactItem),
        typeof(MembershipNonWorkingDayImpactEstimate),
        typeof(MembershipNonWorkingDayOverlapWarning),
        typeof(IMembershipNonWorkingDayReplacementImpactPreparer),
        typeof(MembershipNonWorkingDayReplacementImpactPreparation),
