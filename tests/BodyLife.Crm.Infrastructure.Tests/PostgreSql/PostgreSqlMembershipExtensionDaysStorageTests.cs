...
public sealed class PostgreSqlMembershipExtensionDaysStorageTests
{
    ...
    public async Task DerivedRowsRejectUnknownMembershipAndCanBeRebuiltIndependently()
    {
        ...
        await AssertForeignKeyViolationAsync(
            () => DeleteIssuedMembershipAsync(database.ConnectionString, membershipId),
            "FK_membership_opening_states_issued_memberships_membership_id");
        Assert.Equal(1L, await CountExtensionDaysAsync(database, membershipId));
    }
        ...
        BodyLifeDbContext dbContext)
    {
        ...
        command.CommandText =
            ...
            values (
                @session_id, @actor_account_id, 'Extension storage fixture',
            ...
            values (
                ...
                @base_end_date, 0, 'Extension storage fixture',
