...
public sealed class PostgreSqlMembershipStateCacheStorageTests
{
        ...
        BodyLifeDbContext dbContext)
    {
        ...
        command.CommandText =
            ...
            values (
                @session_id, @actor_account_id, 'Membership cache fixture',
            ...
            values (
                gen_random_uuid(), @membership_id, @start_date, 2, 0,
                @base_end_date, 0, 'Membership cache fixture',
                'Historical state required by the cache scenario', @recorded_at,
                @actor_account_id, @session_id,
