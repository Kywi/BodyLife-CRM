        ...
        string clientStatus)
    {
        ...
        command.CommandText =
            ...
            values (
                ...
                @base_end_date, 0, 'Affected scope fixture',
                'Historical state required by the scope scenario', @recorded_at,
                @actor_account_id,
                (select id from bodylife.sessions where account_id = @actor_account_id limit 1),
