...
{
    options.Conventions.AuthorizePage("/Index", BodyLifeAuthorizationPolicies.AdminOrOwner);
    ...
    options.Conventions.AuthorizeFolder("/Audit", BodyLifeAuthorizationPolicies.AdminOrOwner);
