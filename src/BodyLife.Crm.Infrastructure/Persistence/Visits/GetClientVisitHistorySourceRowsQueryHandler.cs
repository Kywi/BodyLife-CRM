        ...
        GetClientVisitHistorySourceRowsResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var paperReferenceReader = new PaperFallbackEntryRowReferenceReader(
            dbContext);
        var visitPaperReferences = await paperReferenceReader.LoadAsync(
            visitRows.Select(visit => new PaperFallbackEntryRowReferenceSource(
                visit.Id,
                visit.EntryOrigin,
                visit.EntryBatchId,
                visit.OccurredAt,
        ...
        ClientAuditEntry auditEntry)
    {
        ...
        if (!PaperFallbackEntryRowReferenceReader.HasMatchingAuditReference(
                auditEntry,
                visit.EntryBatchId,
                source.VisitPaperReference))
        {
