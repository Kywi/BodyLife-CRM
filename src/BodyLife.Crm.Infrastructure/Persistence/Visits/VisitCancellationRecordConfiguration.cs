...
internal sealed class VisitCancellationRecordConfiguration
    : IEntityTypeConfiguration<VisitCancellationRecord>
{
    public void Configure(EntityTypeBuilder<VisitCancellationRecord> builder)
    {
        builder.ToTable(
            "visit_cancellations",
            table =>
        ...
        builder.Property(cancellation => cancellation.VisitId)
        ...
        builder.HasOne(cancellation => cancellation.Visit)
            .WithMany()
            .HasForeignKey(cancellation => cancellation.VisitId)
        ...
        builder.HasIndex(cancellation => cancellation.VisitId)
            .IsUnique()
            .HasDatabaseName("ux_visit_cancellations_visit_id");
        ...
        builder.HasIndex(cancellation => new
        {
            ...
            .HasDatabaseName("ix_visit_cancellations_timeline");

        builder.HasIndex(cancellation => cancellation.RecordedByAccountId)
            .HasDatabaseName("ix_visit_cancellations_recorded_by_account_id");

        builder.HasIndex(cancellation => cancellation.SessionId)
            .HasDatabaseName("ix_visit_cancellations_session_id");
    }
}
